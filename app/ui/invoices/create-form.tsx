...
import { createInvoice, State } from '@/app/lib/actions'; // Single import handled here
import { 
  CheckIcon, 
  ClockIcon, 
  CurrencyDollarIcon, 
...
export default function Form({ customers }: { customers: CustomerField[] }) { 
  ...
  // Hook uses createInvoice action
  const [state, formAction] = useActionState(createInvoice, initialState); 

  return ( 
    /* Fix: Bound to formAction instead of raw createInvoice */
